...
export function buildSiteHtml(): string {
  ...
  return `<section class="hero is-fullheight"><div class="container main-container"><div class="columns is-gapless"><div class="column desktop-column left is-hidden-mobile"><picture class="desktop-hero-img"><source srcset="/images/side-dog-left-v2.webp" type="image/webp"><img src="/images/side-dog-left-v2.jpg" alt="嚎大大雞霸 無添加" width="634" height="1360" class="desktop-hero-img-el"></picture></div><div class="column is-3 mobile"><div class="mobile-wrapper"><div class="mobile-hero"><div class="hero-drive-wrap"><picture class="hero-image hero-drive"><source srcset="/images/hero-center-v2.webp" type="image/webp"><img src="/images/hero-center-v2.jpg" alt="嚎大大雞霸 實驗結果海報" width="1133" height="1360" decoding="async" fetchpriority="high" class="hero-drive-img"></picture><a class="furmosa-hotspot" href="${escapeAttr(line)}" target="_blank" rel="noopener noreferrer" title="加入 ${escapeAttr(handle)}" aria-label="加入 LINE ${escapeAttr(handle)}"></a></div><div class="product-showcase"><img src="/images/haodada/product-reference.jpeg" alt="嚎大大雞霸 實品包裝" width="1022" height="1602" class="product-reference-img" decoding="async"></div><div class="mobile-text"><div class="c2a-wrapper"><a href="${escapeAttr(line)}" target="_blank" rel="noopener noreferrer" title="加入 ${escapeAttr(handle)}" class="button c2a-phone-hero c2a-line-hero" aria-label="加入 LINE ${escapeAttr(handle)}"><span class="c2a-line-label">加入 ${escapeAttr(handle)}</span></a></div></div></div><div class="mobile-messages"><div class="chat-video-wrap"><video class="chat-product-video" controls playsinline preload="metadata" width="1280" height="720" src="/images/haodada/dogpark-product.mp4"></video></div><div class="chat">${renderChat()}</div></div></div></div><div class="column desktop-column right is-hidden-mobile"><picture class="desktop-hero-img"><source srcset="/images/side-dog-right-v2.webp" type="image/webp"><img src="/images/side-dog-right-v2.jpg" alt="嚎大大雞霸 純雞情" width="627" height="1360" class="desktop-hero-img-el"></picture></div></div></div></section>`;
}
